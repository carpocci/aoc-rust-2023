...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `65.7µs` | `1.1ms` |
| [Day 2](./src/bin/02.rs) | `40.7µs` | `67.8µs` |
| [Day 3](./src/bin/03.rs) | `116.2µs` | `197.9µs` |
| [Day 4](./src/bin/04.rs) | `323.6µs` | `337.0µs` |
| [Day 5](./src/bin/05.rs) | `27.8µs` | `-` |
